...
# 匯入後端資料庫工具 (加入 get_weekly_password)
try:
    ...
    def get_weekly_password(*args, **kwargs): return "888888"
...
''', unsafe_allow_html=True)
st.markdown('<p style="color:#64748b;font-size:1.0rem;margin:0 0 16px 4px;">點擊展開案例，看看統計如何在真實工程中發揮關鍵作用</p>', unsafe_allow_html=True)
