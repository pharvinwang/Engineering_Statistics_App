...
# ─────────────────────────────────────────────────────────────────────
WEEK_MENU = [
    ("Week 01", "📐 第 1 章：統計在工程決策中的角色"),
    ("Week 02", "📊 第 2 章：統計資料之描述與探討"),
    ("Week 03", "🎲 第 3 章：機率與系統可靠度"),
    ("Week 04", "🔢 第 4 章：離散機率分配"),
    ("Week 05", "📈 第 5 章：連續機率分配與壽命工程"),
    ("Week 06", "📉 第 6 章：抽樣分配與中央極限定理"),
    ("Week 07", "🧪 第 7 章：點估計與信賴區間"),
    ("Week 08", "📝 期中考試"),
    ("Week 09", "✅ 第 8 章：統計假設檢定程序"),
    ("Week 10", "✅ 第 8 章：母體比例與兩母體比較"),
    ("Week 11", "📏 第 9 章：變異數分析 (ANOVA)"),
    ("Week 12", "📐 第10章：迴歸分析（前半）"),
    ("Week 13", "🔗 第10章：迴歸分析與多維數據決策（後半）"),
    ("Week 14", "🏭 第11章：實驗設計 (DOE)"),
    ("Week 15", "🏆 第12章：製程能力與產品放行決策"),
    ("Week 16", "📝 期末考試"),
]
